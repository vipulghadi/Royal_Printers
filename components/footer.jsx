...
export default function Footer() {
  return (
    <footer className="bg-gray-900 text-gray-400  rounded-2xl mt-5 mb-5 p-4"> 
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm mb-4">
              We are dedicated to providing the best service and products. Our
              mission is to innovate and lead in our industry, creating value
              ...
              <Link href="#" className="text-gray-400 hover:text-white" aria-label="Twitter">
                ...
                >
                  <path
                    ...
                    4.108 0 003.834 2.85A8.233 8.233 0 012
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="#" className="hover:text-white hover:underline">Services</Link></li>
        ...
        <div className="border-t border-gray-700 pt-8 text-center text-sm">
          © 2024 YourBrand. All rights reserved. Built with Tailwind CSS.
        </div>
      </div>
    </footer>
  );
